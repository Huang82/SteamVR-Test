...
public class PickUpTest : MonoBehaviour
{
	...
	void Update()
	{
		...
		bool right_ = steamVRB_Right.GetState(Player.instance.rightHand.handType);

		if (right_)
            SpawnAndAttachObject(Player.instance.rightHand, GrabTypes.Scripted);
    }
	...
	private void SpawnAndAttachObject(Hand hand, GrabTypes grabType)
	{
		...
		spawnedItem = GameObject.Instantiate(prefabGO);
		...
		//{
		//	GameObject otherHandObjectToAttach = GameObject.Instantiate(prefabGO);
